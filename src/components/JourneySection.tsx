            ...
            <div className="space-y-6">
              {workExperiences.map((exp, i) => (
                <motion.div
                  ...
                  className="glass-card rounded-xl p-6 border-l-4 border-primary hover:shadow-[0_0_20px_hsl(var(--primary)/0.15)] transition-shadow duration-300"
                >
            ...
            <div className="space-y-6">
              {educationExperiences.map((exp, i) => (
                <motion.div
                  ...
                  animate={inView ? { opacity: 1, x: 0 } : {}}
                  transition={{ duration: 0.5, delay: i * 0.15 }}
                  className="glass-card rounded-xl p-6 border-l-4 border-accent hover:shadow-[0_0_20px_hsl(var(--accent)/0.15)] transition-shadow duration-300"
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div
                      className={`w-10 h-10 rounded-lg ${exp.logoBg} flex items-center justify-center overflow-hidden shrink-0 p-1`}
                  ...
                  <p className="text-sm text-accent font-body font-medium mb-2">
                    {exp.role}
                  </p>
                  <p className="text-xs text-muted-foreground mb-3">
                    {exp.location}
